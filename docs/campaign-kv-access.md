...
> curl -fsS \
>   -H "Authorization: Bearer AVIxAAIncDEwMzc2NTgwYzgzOTc0NzUzYjIxMzY3Y2U2NzdkNjY1MXAxMjEwNDE" \
>   "https://hot-louse-21041.upstash.io/get/cmp%3Aids" | jq .
> ```
>
> Якщо відповідь — масив/рядок із ідентифікаторами (наприклад, `["cmp:item:123","cmp:item:456"]`), значить, дані кампаній присутні й `kvRead.listCampaigns` зможе їх побачити. Статус 200 із `null` або порожнім масивом означає, що доступ є, але записи ще не залиті; у такому випадку перевірте, що процес синхронізації KeyCRM → KV відпрацьовує коректно.
