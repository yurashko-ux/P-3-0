...
export function ManychatCampaignRouter() {
  ...
  if (successPayload) {
    ...
    const moveAttempted = moveDetails.attempted;
          ...
          <>
            {moveAttempted ? (
              <>
                ...
                {moveDetails.requestMethod && moveDetails.requestUrl && (
                  <div className="text-sm text-slate-600">
                    Запит: {moveDetails.requestMethod} {moveDetails.requestUrl}
                  </div>
                )}
                {moveDetails.sent && (
                  <div className="space-y-1">
                    <div className="text-xs uppercase text-slate-400">Тіло запиту</div>
                    <JsonViewer value={moveDetails.sent} />
                  </div>
                )}
