...
export function ManychatCampaignRouter() {
  ...
  if (successPayload) {
    ...
    const baseStatusCandidates = campaignBase
      ? [
          normalizeId(campaignBase.pipelineStatusId),
          normalizeId(campaignBase.statusId),
          ...(campaignBase.statusAliases ?? []).map((value) => normalizeId(value)),
