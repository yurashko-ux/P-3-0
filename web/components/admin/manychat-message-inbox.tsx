            ...
            <p className="mt-2 text-sm text-amber-700">
              {apiDiag.ok
                ? (() => {
                    switch (apiDiag.note) {
                      case "empty":
                        return "✅ Дані отримано (повідомлення відсутні)";
                      case "fetched":
                        return "✅ Дані отримано (є нові повідомлення)";
                      case "fetched-empty":
                        return "✅ Дані отримано (ManyChat не повернув текст, використано наявний журнал)";
                      case "ignored-empty":
                        return "✅ Дані отримано (відповідь ManyChat без тексту, залишено поточний журнал)";
                      default:
