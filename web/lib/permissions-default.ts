...
export const PERMISSION_CATEGORIES: { key: PermissionKey; label: string }[] = [
  ...
  { key: "warehouseSection", label: "Розділ Склад" },
  { key: "journalSection", label: "Розділ Журнал" },
  { key: "teamSection", label: "Розділ Команда" },
  { key: "financeDocsSection", label: "Розділ Фінанси (документи)" },
