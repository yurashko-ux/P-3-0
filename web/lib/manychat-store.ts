...
export async function persistManychatSnapshot(
  ...
  // Навіть якщо клієнт @vercel/kv спрацював, дублюємо запис через REST,
  // щоб інші лямбди без клієнта бачили ті ж дані.
  try {
    ...
    // Ігноруємо — якщо REST недоступний, покладаємось на клієнт.
  }
