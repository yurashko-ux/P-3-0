      ...
      for (let page = 1; page <= maxPages; page++) {
        ...
        if (subscribersResponse.ok) {
          ...
          if (foundSubscriber) {
            ...
            console.log(`[reminders] ✅ Found subscriber via getSubscribers: ${subscriberId}`, JSON.stringify(foundSubscriber, null, 2));
            break;
          }
          ...
          console.warn(`[reminders] getSubscribers failed: ${subscribersResponse.status} ${errorText}`);
          break;
        }
      }
    } catch (err) {
