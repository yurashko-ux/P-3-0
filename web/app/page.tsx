...
{`{
  ...
  "allow": [
    ...
    "OPTIONS"
      ...
      <button onClick={testPost} className="px-4 py-2 rounded-md bg-neutral-900 text-white">
        Тестовий POST на /api/public/mc/ingest-proxy
      </button>
      {postResult && <div className="text-sm text-gray-700 border rounded-md p-3">{postResult}</div>}

      {/* Навігація в адмінку */}
      <div className="pt-6 border-t mt-6">
        <h2 className="text-xl font-semibold mb-3">Адмінка → Кампанії</h2>
        <div className="flex gap-3 flex-wrap">
          <a href="/admin/campaigns" className="px-5 py-3 rounded-md bg-black text-white text-base">
            Відкрити «Кампанії» (список)
          </a>
          <a href="/admin/campaigns/new" className="px-5 py-3 rounded-md border text-base">
