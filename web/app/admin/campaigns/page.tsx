  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        if (!res.ok || json?.ok === false) throw new Error(json?.error || 'Помилка завантаження');
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <a href="/admin/campaigns/new" className="px-4 py-2 rounded-md bg-black text-white">New</a>
      </div>
