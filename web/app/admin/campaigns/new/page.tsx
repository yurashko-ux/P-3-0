...
export default function NewCampaignPage() {
  ...
  const [v1Value, setV1Value] = useState(''); // варіант відповіді з ManyChat
        ...
        <div className="rounded-2xl border p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input
                className="w-full rounded-xl border px-3 py-2"
                placeholder="варіант відповіді з ManyChat"
                value={v1Value}
        ...
        <div className="rounded-2xl border p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input
                className="w-full rounded-xl border px-3 py-2"
                placeholder="опційно — значення з ManyChat"
                value={v2Value}
