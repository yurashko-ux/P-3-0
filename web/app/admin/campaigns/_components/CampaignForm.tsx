...
export default function CampaignForm() {
  ...
  // ---- KV-backed dictionaries (через наші API-проксі) ----
  ...
  // Скидання залежних селектів при зміні pipeline
  function onChangeBasePipeline(pid: string) {
    setDraft((d) => ({
      ...d,
      base_pipeline_id: pid,
      base_status_id: "",
    }));
  }
            ...
            <div className="grid grid-cols-3 gap-2">
              <Select
                ...
                onChange={(v) =>
                  setDraft((d) => ({
                    ...d,
                    v1_condition: { ...(d.v1_condition ?? emptyCond), field: v as any },
                  }))
                }
              >
              ...
              <Select
                ...
                onChange={(v) =>
                  setDraft((d) => ({
                    ...d,
                    v1_condition: { ...(d.v1_condition ?? emptyCond), op: v as any },
                  }))
                }
              >
              ...
              <input
                ...
                onChange={(e) =>
                  setDraft((d) => ({
                    ...d,
                    v1_condition: { ...(d.v1_condition ?? emptyCond), value: e.target.value },
                  }))
                }
        ...
        <div className="flex items-center justify-between">
          ...
          <label className="inline-flex items-center gap-2 text-sm text-slate-600">
            <input
              ...
              onChange={(e) =>
                setDraft((d) => ({ ...d, v2_condition: e.target.checked ? emptyCond : null }))
              }
              ...
              <div className="grid grid-cols-3 gap-2">
                <Select
                  ...
                  onChange={(v) =>
                    setDraft((d) => ({
                      ...d,
                      v2_condition: { ...(d.v2_condition ?? emptyCond), field: v as any },
                    }))
                  }
                >
                  <option value="any">будь-що</option>
                ...
                <Select
                  ...
                  onChange={(v) =>
                    setDraft((d) => ({
                      ...d,
                      v2_condition: { ...(d.v2_condition ?? emptyCond), op: v as any },
                    }))
                  }
                >
                  <option value="contains">містить</option>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDraft((d) => ({
                      ...d,
                      v2_condition: { ...(d.v2_condition ?? emptyCond), value: e.target.value },
                    }))
                  }
                  className="w-full rounded-2xl border border-gray-300 bg-white px-3 py-2 outline-none ring-1 ring-gray-300 focus:ring-2 focus:ring-blue-500"
                />
