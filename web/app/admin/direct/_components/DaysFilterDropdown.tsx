...
const OPTIONS: { id: DaysOption; label: string; tooltip: string }[] = [
  {
    id: "activeBase",
    label: "Активна база",
    tooltip: "0–100 днів з останнього платного візиту або майбутній платний запис",
  },
  {
    id: "inactiveBase",
    label: "Неактивна база",
    tooltip: "Платна послуга в історії: 101+ днів з платного візиту без майбутнього платного запису",
  },
  { id: "consultation", label: "Консультації", tooltip: "Є запис/візит на консультацію, але не було жодної платної послуги" },
  { id: "none", label: "Немає", tooltip: "Немає даних про дні з останнього платного візиту (прочерк)" },
  { id: "growing", label: "Відростає (0–60)", tooltip: "0–60 днів з останнього платного візиту" },
  { id: "grown", label: "Відросло (60–90)", tooltip: "60–90 днів з останнього платного візиту" },
  { id: "overgrown", label: "Переросло (90+)", tooltip: "90+ днів з останнього платного візиту" },
];
