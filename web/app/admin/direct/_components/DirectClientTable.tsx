                ...
                <table className="table table-xs sm:table-sm border-collapse" style={tableWidthStyle}>
                  ...
                  <thead className="bg-base-200">
                    <tr className="bg-base-200">
                      <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getStickyColumnStyle(columnWidths.number, getStickyLeft(0), true)}>№</th>
                  <th className="px-0 py-1 text-xs font-semibold bg-base-200 text-left" style={getStickyColumnStyle(columnWidths.act, getStickyLeft(1), true)}>
                  ...
                  <th className="px-0 py-1 bg-base-200 text-left" style={getStickyColumnStyle(columnWidths.avatar, getStickyLeft(2), true)} />
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getStickyColumnStyle(columnWidths.name, getStickyLeft(3), true)}>
                  ...
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.sales, true)}>
                    <div className="flex flex-col items-start leading-none">
                      <button
                  ...
                  <th
                    className="px-1 sm:px-1 py-1 text-xs font-semibold bg-base-200 text-left"
                  ...
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.inst, true)}>
                    <div className="flex items-center gap-1">
                      <button
                  ...
                  <th className="pl-1 pr-2 sm:pl-1 sm:pr-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.state, true)}>
                  ...
                  <th className="pl-2 sm:pl-2 pr-1 sm:pr-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.consultation, true)}>
                    <div className="flex items-center gap-1">
                      <button
                  ...
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.record, true)}>
                    <div className="flex items-center gap-1">
                      <button
                  ...
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.master, true)}>
                    <div className="flex items-center gap-1">
                      <button
                  ...
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.phone, true)}>
                    Телефон
                  </th>
                  <th className="px-1 sm:px-2 py-1 text-xs font-semibold bg-base-200 text-left" style={getColumnStyle(columnWidths.actions, true)}>Дії</th>
                </tr>
