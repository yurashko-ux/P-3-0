                        ...
                        <thead>
                          <tr>
                            ...
                            <th
                              data-cell="C27"
                              data-block={blockId}
                              title="Сума фактичних вхідних оплат від початку місяця до сьогодні або до кінця вибраного минулого місяця. Беремо лише транзакції з номером документа. Для майбутнього місяця тут 0. Показуємо в тис.; точна сума є в hover."
                            >
                              З початку місяця
                            </th>
                            <th
