...
function getActiveBaseDeltaBadgeClass(deltaCount: number, compact = false): string {
  const base = compact
    ...
    >
      {sortedPoints.length === 0 ? (
        ...
        <>
          ...
          <div
            className="h-72 flex gap-1 border-b border-base-300 px-1 pt-3 overflow-hidden cursor-ew-resize"
            onWheel={handleWheel}
          >
            {visiblePoints.map((p) => {
