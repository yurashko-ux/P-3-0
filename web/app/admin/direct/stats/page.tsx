                        ...
                        <thead>
                          <tr>
                            ...
                            <th
                              data-cell="C27"
                              data-block={blockId}
                              title="Сума реальних оплат по ID записів від початку місяця до сьогодні або до кінця вибраного минулого місяця. Спочатку беремо записи Altegio за датами, потім по їх record_id тягнемо timetable/transactions. Для майбутнього місяця тут 0. Показуємо в тис.; точна сума є в hover."
                            >
                              З початку місяця
                            </th>
                            <th
