    ...
    <main style={{ maxWidth: 1040, margin: '48px auto', padding: '0 20px' }}>
      ...
      >
        ...
        <Card>
          ...
          <CardBody>
            <ul style={{ margin: 0, paddingLeft: 18, color: 'rgba(0,0,0,0.75)' }}>
              <li>Перевірка KV-конфігурації та fallback-запасних значень</li>
              <li>Останні ManyChat webhook-и та історія переміщень</li>
              <li>Швидкий перехід до ручних віджетів для діагностики</li>
            </ul>
          </CardBody>
          <CardFooter>
  ...
  return (
    <Link
      ...
      style={{
        ...
        borderRadius: 14,
        fontWeight: 600,
        boxShadow: 'inset 0 0 0 1px rgba(28,35,64,0.1)',
      }}
    >
      {children}
    </Link>
